...
# Тестовое задание
### Модули сервиса:
* **Модуль анализа жалоб** `complait_analyzer`
* **Модуль сторонних API** `external_apis`
    * *Определение геолокации*
    * *Определение категории*
    * *Определение тональности* (целевой API принимает на вход английский язык)
...
* Репозиторий управления обращениями `app/modules/complait_analyzer/uow.py`
### Middlware:
